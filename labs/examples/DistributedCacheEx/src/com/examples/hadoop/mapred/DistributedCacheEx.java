...
public class DistributedCacheEx {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(DistributedCacheEx.class);
		job.setJobName("DCTest");
		job.setNumReduceTasks(0);

		try {
			DistributedCache.addCacheFile(new URI("/user/training/distcache/abc.dat"), job.getConfiguration());
		} catch (Exception e) {
