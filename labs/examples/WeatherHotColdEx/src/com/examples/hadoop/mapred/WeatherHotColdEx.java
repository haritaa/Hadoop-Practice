...
public class WeatherHotColdEx {
	...
	public static class MaxTemperatureMapper extends Mapper<LongWritable, Text, Text, Text> {
		...
		/**
		 * @method map This method takes the input as text data type. Now
		 *         leaving the first five tokens,it takes 6th token is taken as
		 *         temp_max and 7th token is taken as temp_min. Now temp_max >
		 *         35 and temp_min < 10 are passed to the reducer.
		 */
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(WeatherHotColdEx.class);
		...
		// deleting the context path automatically from hdfs so that we don't
